...
import logo from "../Assets/LOGO_AULIA.png"; 
...
function NavBar() {
  ...
  return (
    ...
    >
      <Container>
        <Navbar.Brand as={Link} to="/" className="d-flex text-white fw-bold">
          <span style={{ fontSize: "1.5rem", letterSpacing: "2px" }}>APM</span>
        </Navbar.Brand>
